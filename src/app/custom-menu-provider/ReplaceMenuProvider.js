 ...
 * @return {Array<Object>} a list of menu entry items
 */
CustomMenuProvider.prototype.getHeaderEntries = function (element) {
  var headerEntries = [];
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomMenuProvider.prototype._createSequenceFlowEntries = function (
  element,
  // eslint-disable-next-line @typescript-eslint/no-shadow
  replaceOptions
) {
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomMenuProvider.prototype._getLoopEntries = function (element) {
  // eslint-disable-next-line @typescript-eslint/no-this-alias
  var self = this;
  var translate = this._translate;
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomMenuProvider.prototype._getDataObjectIsCollection = function (element) {
  // eslint-disable-next-line @typescript-eslint/no-this-alias
  var self = this;
  var translate = this._translate;
 ...
 * @return {Array<Object>} a list of menu items
 */
CustomMenuProvider.prototype._getParticipantMultiplicity = function (element) {
  // eslint-disable-next-line @typescript-eslint/no-this-alias
  var self = this;
 ...
 */
CustomMenuProvider.prototype._getAdHocEntry = function (element) {
  var translate = this._translate;
  var businessObject = getBusinessObject(element);
